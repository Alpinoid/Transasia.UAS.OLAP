...
IF OBJECT_ID('[olap].[v_13_ДокументыРеализацияТоваров]','V') IS NOT NULL
	DROP VIEW [olap].[v_13_ДокументыРеализацияТоваров]
GO

CREATE VIEW [olap].[v_13_ДокументыРеализацияТоваров]
AS
